...
public class ReturnCode {
    ...
    public static final String CODE_INVALIDATED_LOGIN = "-105";
    /** token失效 */
    public static final String CODE_INVALIDATED_TOKEN =" 100001";
    /** appId无效 */
    public static final String CODE_INVALIDATED_APPID = "109";
    /** 数据为空 */
    public static final String CODE_EMPTY = "1004";
    /** 密码输入多次错误 */
    public static final String CODE_PASSWORD_ERROR = "000038";

    /** 用户冻结 */
    public static final String CODE_USER_FREEZE ="000028";
}
