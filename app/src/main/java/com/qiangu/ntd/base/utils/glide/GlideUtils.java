...
import com.qiangu.ntd.view.widget.GlideCircleTransform;
import com.qiangu.ntd.view.widget.GlideRoundTransform;
import java.io.File;
...
public class GlideUtils {
    ...
    public static void displayCircleHeaderNative(ImageView view,
                                           @DrawableRes int res) {
        // 不能崩
        if (view == null) {
            Log.e(TAG, "GlideUtils -> display -> imageView is null");
    ...
    public static void downLoadImage(final String url, final String destFileDir, final Context context) {
        Log.d("result",url+"哦"+destFileDir);
